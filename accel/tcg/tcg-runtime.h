...
DEF_HELPER_FLAGS_1(afl_on_entry_routine, TCG_CALL_NO_RWG, void, env)
DEF_HELPER_FLAGS_2(afl_persistent_routine, TCG_CALL_NO_RWG, void, env, tl)
DEF_HELPER_FLAGS_1(afl_enable_persistent, TCG_CALL_NO_RWG, void, env)
